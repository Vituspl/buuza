<template>
  <div class="bg-white m-auto p-6 w-full max-w-3xl min-w-80">
    ...
    <h1 class="text-center text-xl"><b>Политика в отношении обработки персональных данных</b></h1>
    <div class="block mt-8">
      <p>
        <b>1. Общие положения</b>
        <br/>
        <br/>
        Настоящая политика обработки персональных данных составлена в соответствии с требованиями <b>Федерального закона
        от 27.07.2006. №152-ФЗ «О персональных данных»</b> и определяет порядок обработки персональных данных и меры по
        обеспечению безопасности персональных данных <b>ИП Лефанд Владимир Юрьевич (далее – Оператор)</b>.
        <br/>
        ...
        информации, которую Оператор может получить о посетителях веб-сайта <b>https://matreshka-lozhka.ru</b>.
        <br/>
        <br/>
        ...
        обеспечивающих их доступность в сети интернет по сетевому адресу <b>https://matreshka-lozhka.ru</b>;
        <br/>
        ...
        Пользователю веб-сайта <b>https://matreshka-lozhka.ru</b>;
        <br/>
        9. Пользователь – любой посетитель веб-сайта <b>https://matreshka-lozhka.ru</b>;
        <br/>
        ...
        3. Номера телефонов;
        <br/>
        4. Отзыв о сети столовых, адрес фактического пребывания (для доставки заказа);
        <br/>
        5. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с
        ...
        <br/>
        1. Цель обработки персональных данных Пользователя — информирование пользователя посредством звонка оператора,
        выполнение обязательств по готовке и доставке блюд в соответствии с заказом.
        <br/>
        ...
        направив Оператору письмо на адрес электронной почты <b>mlozka2019@mail.ru</b> с пометкой «Отказ от уведомлениях о
        ...
        Пользователем самостоятельно через специальные формы, расположенные на сайте <b>https://matreshka-lozhka.ru</b>.
        ...
        путем направления Оператору уведомление на адрес электронной почты Оператора <b>mlozka2019@mail.ru</b> с пометкой
        ...
        электронный адрес Оператора <b>mlozka2019@mail.ru</b> с пометкой «Отзыв согласия на обработку персональных данных».
        <br/>
        <br/>
        ...
        данных, обратившись к Оператору с помощью электронной почты <b>mlozka2019@mail.ru</b>.
        <br/>
        ...
        <b>https://matreshka-lozhka.ru/#popup:confident</b>.
      </p>
